...
static uint8_t ButtonPressCounter, ExampleTask2ID, ExampleTask3ID;
...
uint8_t ExampleTask1 (TISM_Task ThisTask)
{
  ...
  switch(ThisTask.TaskState)   
  {
    case INIT:  // Activities to initialize this task (e.g. initialize ports or peripherals).
                ...
                ExampleTask2ID=TISM_GetTaskID("ExTask2");
                ExampleTask3ID=TISM_GetTaskID("ExTask3");
                ...
                while((TISM_PostmanTaskMessagesWaiting(ThisTask)>0) && (MessageCounter<MAX_MESSAGES))
                {
                  ...
                  switch(MessageToProcess->MessageType)
                  {
                    ...
                    case EXAMPLE1GPIO: /* 
                                       ...
                                       */
                                       switch(MessageToProcess->Payload0)
                                       {
                                         case GPIO_IRQ_EDGE_FALL: // Button is pressed.
                                                                  ...
                                                                  TISM_PostmanTaskWriteMessage(ThisTask,System.HostID,ExampleTask2ID,MessageToProcess->Payload0,0,0);
                                                                  TISM_PostmanTaskWriteMessage(ThisTask,System.HostID,ExampleTask3ID,MessageToProcess->Payload0,0,0);
                                       ...
                                       ButtonPressCounter++;
                                       if (ThisTask.TaskDebug) TISM_EventLoggerLogEvent(ThisTask, TISM_LOG_EVENT_NOTIFY, "Number of events: %d", ButtonPressCounter);
